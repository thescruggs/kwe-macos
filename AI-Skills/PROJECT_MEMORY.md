...
**Current as of:** 2026-08-22 (M3g merged and verified). Read `INSTRUCTIONS.md` first; `BETA_PLAN.md` is the living plan.
...
- **History (all ff-merged into the trunk):** `1833331` Qt 6.11 fix → `db8563d` AI-Skills → BETA_M1 (M1a–M1e) → BETA_M2 (M2a–M2e, `dc125d8`) → M3a–M3f (`d4ea8c2`+`5abc800`) → M4a `cffb7cd`+`f3376c7` → M4b `eb83966`+`e6152bd` → M4c `e5d69e0`+`520b2d7` → M4d `0d8a883` → M3g `3b368d2`+`0087c06`. Full per-slice detail lives in BETA_PLAN.md's change log.
